...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(180, 120, 201, 141))
        font = QtGui.QFont()
        ...
        #calls the buttons and trigger+connect          das lambda muss da einfach hin
        self.actionNew.triggered.connect(lambda : self.clicked('New was clicked')) # trigger also allows shortcuts to work
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionCopy.setStatusTip(_translate("MainWindow", "Save a file"))
